...
public class InstrumentationAgent {
	...
	/**
	 * Implementation of the overloaded premain method that is first invoked by the
	 * JVM during use of instrumentation.
	 * 
	 * @param agentArgs Agent options provided as a single String.
	 * @param inst      Handle to instance of Instrumentation provided on
	 *                  command-line.
	 */
